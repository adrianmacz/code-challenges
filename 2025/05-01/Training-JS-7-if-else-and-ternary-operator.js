...
// p - boolean? numbers? whole numbers? strings?
// r - hot dog sales
//     if the number of hd are under 5 each hd is 100 each
//     if they are between 5 and 10 they are 95 each
//     if they are greater or equal to 10 then they cost 90 each
// e - saleHotdogs(1, 100)
//     saleHotdogs(5,475)
//     saleHotdogs(10, 900)
// p - if else if else statements
//     if the number of hd are under 5 each hd is 100 each
//     if they are between 5 and 10 they are 95 each
//     if they are greater or equal to 10 then they cost 90 each
